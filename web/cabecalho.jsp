  ...
  <div class="wrapper ">
    ...
    -->
      <div class="sidebar-wrapper">
        <div class="logo">
          <a href="../inicial/index.html" class="simple-text logo-normal text-center">
            Biblioteca
          </a>
        </div>
        <ul class="nav">
          ...
          <li>
            <a href="/../login/LoginWS?acao=list">
              <i class="tim-icons icon-tag"></i>
              <p>Login</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent   ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="../inicial/index.jsp">Biblioteca online</a>
          </div>
